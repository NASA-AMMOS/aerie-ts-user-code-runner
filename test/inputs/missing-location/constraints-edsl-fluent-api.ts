...
declare global {
  ...
  export class Spans {
     ...
     * Instantaneous zero-width spans will be left unchanged.
     * If an extremely small spans contains fewer microseconds than N, each microsecond
     * will be its own span.
     *
     * @param numberOfSubSpans how many sub-spans to split each window into
     */
    public split(numberOfSubSpans: number): Spans;
